  ...
  return (
    <div className="relative">
      <div className="flex items-center gap-3 mb-4">
        ...
        <div className="h-px flex-1 bg-gradient-to-r from-feldora-accent-secondary/30 to-transparent max-w-32" />
      </div>
      <h1 className="text-5xl md:text-7xl lg:text-8xl font-black uppercase tracking-tight leading-[0.85]">
        {title}
      </h1>
      {description && (
        <div className="mt-6 pl-4 border-l-2 border-feldora-accent-secondary/50 max-w-2xl">
