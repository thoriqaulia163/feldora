  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-sm card-polygon p-6 animate-fade-in">
        <h3 className="flex items-center gap-2 text-feldora-text font-bold text-lg mb-4">
          <svg className="w-5 h-5 text-feldora-accent-secondary" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
