export const PLAYGROUND_COPY = {
  ...
  weatherV3: {
    ...
    description:
      'Per-slot rain prediction using a Neural Network with learned location embeddings.',
    cityLabel: 'City',
    cityPlaceholder: 'Search city...',
    dateLabel: 'Date',
    prevDayLabel: 'Cuaca Kemarin',
    ...
    aboutTitle: 'About',
    aboutDescription:
      'This module predicts rain/no-rain for four time slots — Pagi (05:00–10:59), Siang (11:00–14:59), Sore (15:00–17:59), Malam (18:00–04:59) — using a shared Neural Network (MLP) with learned location embeddings (dim=8) and cyclical temporal encoding. Architecture: Dense [64, 32, 16] + ReLU + 4 Sigmoid heads. Standard mode: 72.76% accuracy, 60.30% Macro F1. Sensitive mode: 69.49% accuracy, 64.16% Macro F1.',
    aboutFeatures:
      'Features: day of year (+ sin/cos), month (sin/cos), latitude, longitude, elevation, monsoon zone, local season, ENSO phase, IOD phase, previous day rain, and computed day length. Location embedding learned during training. Model size ~64 KB — 5× smaller than V2.5. Runs entirely in-browser.',
    disclaimer:
      'Predictions are experimental and should not be used as a primary reference. Results are based on historical climatological patterns with limited parameters, not real-time atmospheric data. Use official meteorological services (BMKG) for critical decisions.',
  },
  weatherV3_1: {
    ...
    description:
      'Improved NN with larger capacity (128→64→32, embedding dim=16).',
    cityLabel: 'City',
    cityPlaceholder: 'Search city...',
    dateLabel: 'Date',
    prevDayLabel: 'Cuaca Kemarin',
    ...
    aboutTitle: 'About',
    aboutDescription:
      'V3.1 experiment: tests whether V3 was under-capacity by increasing hidden layers to [128, 64, 32] and embedding dimension to 16. Same feature set as V3 to isolate the architecture improvement. Standard mode: 72.56% accuracy, 60.74% Macro F1. Sensitive mode: 69.62% accuracy, 64.08% Macro F1.',
    aboutFeatures:
      'Architecture: Shared MLP with Dense [128, 64, 32] + ReLU + 4 Sigmoid heads. Location embedding dim=16. Same 14 features as V3. Model size ~180 KB. Conclusion: larger capacity did not yield meaningful improvement over V3 (64 KB), suggesting the bottleneck is in data/features rather than model capacity.',
    disclaimer:
      'Predictions are experimental and should not be used as a primary reference. Results are based on historical climatological patterns with limited parameters, not real-time atmospheric data. Use official meteorological services (BMKG) for critical decisions.',
  },
  weatherV3_3: {
    ...
    description:
      'Four independent NNs — one per time slot. Tests slot-specific specialization.',
    cityLabel: 'City',
    cityPlaceholder: 'Search city...',
    dateLabel: 'Date',
    prevDayLabel: 'Cuaca Kemarin',
    ...
    howToUseSteps: [
      ...
      'Select yesterday\'s weather condition.',
      '(Optional) Set ENSO & IOD phase in Advanced Settings.',
      'Toggle mode: Standard (conservative) or Sensitive (better rain detection).',
      'Click Predict to see rain forecast for all time slots.',
    ],
    loadingModel: 'Loading model...',
    predicting: 'Predicting...',
    ...
    aboutTitle: 'About',
    aboutDescription:
      'V3.3 uses 4 independent Neural Networks — each slot (Morning, Afternoon, Evening, Night) has its own embedding, backbone [64, 32, 16], and output head. This tests whether slot-specific specialization outperforms V3\'s shared representation. Standard mode: 72.68% accuracy, 60.29% Macro F1. Sensitive mode: 70.48% accuracy, 63.94% Macro F1.',
    aboutFeatures:
      'Architecture: 4× independent MLP with Dense [64, 32, 16] + ReLU + Sigmoid. Each model has its own location embedding (dim=8) trained independently. Same 14 features as V3. Model size ~242 KB. Result: independent networks did not outperform V3 shared representation (64 KB).',
    disclaimer:
      'Predictions are experimental and should not be used as a primary reference. Results are based on historical climatological patterns with limited parameters, not real-time atmospheric data. Use official meteorological services (BMKG) for critical decisions.',
  },
  aiUpscaler: {
